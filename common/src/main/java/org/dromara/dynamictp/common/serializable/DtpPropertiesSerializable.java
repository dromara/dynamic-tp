...
package org.dromara.dynamictp.common.serializable;
 ...
 **/
@Data
public class DtpPropertiesSerializable implements Serializable {

    private DtpPropertiesSerializable() { }
    ...
    public static DtpPropertiesSerializable getInstance() {
    ...
    private static class Holder {
        private static final DtpPropertiesSerializable INSTANCE = new DtpPropertiesSerializable();
    }
}
