...
public enum ExecutorType {
    ...
    /**
     * Virtual thread executor type.
     * Spawns one virtual thread per task; requires JDK 21+ at runtime.
     * Note: core/max/queue tuning and dynamic refresh of those params are not supported.
     */
