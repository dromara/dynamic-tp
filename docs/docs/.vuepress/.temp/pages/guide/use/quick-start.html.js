export const data = {
  ...
  "frontmatter": {
    ...
    "sticky": true,
    "star": true,
    "summary": "接入步骤 1.引入相应配置中心的依赖，具体见下述 mavne依赖 2.配置中心配置线程池实例，配置见下述（给出的是全配置项，不用的可以删除） 3.启动类加 @EnableDynamicTp 注解 4.使用 @Resource 或 @Autowired 进行依赖注入，或通过 DtpRegistry.getDtpExecutor(\"name\")获取 5.通过以上",
    "head": [
      [
        "meta",
        {
